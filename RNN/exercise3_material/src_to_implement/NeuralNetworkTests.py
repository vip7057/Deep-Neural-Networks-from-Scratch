...
try:
    LSTM_TEST = True
    from Exercise.Ex03.exercise3_material.src_to_implement.Layers import *
except BaseException as e:
    if str(e)[-6:] == "'LSTM'":
        LSTM_TEST = False
    else:
        raise e
from Exercise.Ex03.exercise3_material.src_to_implement.Optimization import *
import numpy as np
from scipy import stats
from scipy.ndimage import gaussian_filter
from Exercise.Ex03.exercise3_material.src_to_implement import NeuralNetwork
